...
import { PlayerPower, Direction, TankTypes, PowerupTypes, Tiles, } from '../types';
const createSprite = (image, context) => (dx, dy, dWidth, dHeight) => (position, size) => {
...
const setupVariableSprites = (image) => {
    const mainSprite = createSprite(image, main.context);
    return {
        tankSpawn: [
...
//# sourceMappingURL=assetsHolder.js.map