...
import { PLAYER_SPAWN_POSITION, TANK_SIZE, PLAYER_STATS, SPAWN_FRAMES, DEATH_FRAMES, INVINCIBLE_FRAMES, } from '../constants';
...
export class Player extends Tank {
    constructor() {
        super(Object.assign({}, PLAYER_SPAWN_POSITION), Object.assign({}, TANK_SIZE), Direction.Top);
        this.lives = 3;
    ...
    respawn(defaultPower = false) {
        ...
        this.timeManager.setTimer('spawn', SPAWN_FRAMES);
        this.timeManager.setTimer('invincible', INVINCIBLE_FRAMES);
        this.position = Object.assign({}, PLAYER_SPAWN_POSITION);
        this.prevPosition = Object.assign({}, PLAYER_SPAWN_POSITION);
    }
    deconstruct() {
        this.soundManager.pauseAll();
